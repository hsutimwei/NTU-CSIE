...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="./qaout/", help="Where to store the final model.")
...
def main():
    ...
    raw_datasets = load_dataset("dataset.py", data_files=data_files)
...
def postprocess_qa_predictions(
    ...
    if output_dir is not None:
        ...
        prediction_file = "./qaout/pred.json"
